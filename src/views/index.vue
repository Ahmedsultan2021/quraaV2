<template>
  <navbar />
  <div class="main_all" v-if="lasest.length > 0">
    <div class="container1">
      <div class="row">
        ...
        >
          <div class="div_img1">
            <div>
              <img :src="lasest[0].img_url" />
              <!-- <img src="../assets/img1.png" class="img1" height="470" alt=""> -->
              <div class="img_detalis">
                <div class="p_time">
                  {{ lasest[0].from_time }} . {{ lasest[0].time_to_raed }}
                </div>
                <p class="writer">الكاتب:{{ lasest[0].write_by }}</p>
              </div>
              <h1 class="img1_titel1">{{ lasest[0].titel }}</h1>
            </div>
          </div>
        </div>
        <!-- <hr > -->
        ...
        <div class="col-4">
          ...
          <div class="div_img2">
            <img :src="lasest[1].img_url" />
            <!-- <img src="../assets/img1.png" class="img2" height="200" alt=""> -->
            <div class="img_detalis2">
              <div class="p_time2">
                {{ lasest[1].from_time }} . {{ lasest[1].time_to_raed }}
              </div>
              <p class="writer2">الكاتب:{{ lasest[1].write_by }}</p>
            </div>
            <p class="img2_titel2">{{ lasest[1].titel }}</p>
          </div>
          <!-- </div> -->
          <!-- <img :src="last.img1.img_url" /> -->
          <div class="div_img2">
            <div>
              <img :src="lasest[2].img_url" alt="" />
              <!-- <img src="../assets/img1.png" class="img2" height="200" alt=""> -->
              <div class="img_detalis2">
                <div class="p_time2">
                  {{ lasest[2].from_time }} . {{ lasest[2].time_to_raed }}
                </div>
                <p class="writer2">الكاتب:{{ lasest[2].write_by }}</p>
              </div>
              <p class="img2_titel2">{{ lasest[2].titel }}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="lastest_article" v-if="articles.length > 0">
    ...
    <div
      class="container_lastest_article"
      :key="article.id"
      v-for="article in accsept_articals.slice(0, 3)"
    >
      <div class="row lg-my-5 d-flex align-items-center">
        <div class="col-6 article_discription" style="gap: 9px">
          <p class="article_writer">
            كتب بواسطة : {{ article.article_writer }}
            <!-- <hr class="line"> -->
          </p>
          <h3 class="article_title">{{ article.article_title }}</h3>
          <p class="part_of_article">
            {{ article.part_of_article }}
          </p>
          <div class="div">
            <router-link
              class="to_article_page2"
              :to="{ name: 'aricle_page', params: { id: article.id } }"
            >
              أقرأ المزيد
            </router-link>
            <div class="article_time">
              <p class="p_article_from">
                {{ article.article_from }}.{{ article.article_time_read }}
              </p>
            </div>
          </div>
        </div>
        <div class="col-6 col_img">
          <img :src="article.article_img_url" class="article_img" alt="" />
        </div>
      </div>
    </div>
  </div>
